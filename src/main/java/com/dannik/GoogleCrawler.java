...
public class GoogleCrawler {
    ...
    public static List<String> parseSearchResult(String searchTerm, int count, int start) throws Exception {

        String query = "https://www.google.com/search?q=" + searchTerm + "&num=" + count + "&start=" + start;
